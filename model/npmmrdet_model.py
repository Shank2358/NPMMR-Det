...
from model.backbones.darknet53_npattention import Darknet53_NPAttention
from model.necks.msr_fpn import MSR_FPN
from model.head.mtr_head import MTR_Head2
from model.layers.convolutions import Convolutional
from utils.utils_basic import *

class NPMMRDet(nn.Module):
    """
    Note ： int the __init__(), to define the modules should be in order, because of the weight file is order
    """
    def __init__(self, init_weights=True):
        super(NPMMRDet, self).__init__()
