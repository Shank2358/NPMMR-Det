...
from ..layers.msr_blocks import MSR_Convset_L, MSR_Convset_M, MSR_Convset_S
...
class MSR_FPN(nn.Module):
    def __init__(self, fileters_in):
        ...
        self.__conv21down = Deformable_Convolutional(filters_in=256, filters_out=256, kernel_size=3,
                                                     stride=2, pad=1, norm="bn", activate="leaky")
        self.__route21 = Route()
        self.__conv10down = Deformable_Convolutional(filters_in=512 + 256, filters_out=512, kernel_size=3,
                                                     stride=2, pad=1, norm="bn", activate="leaky")
