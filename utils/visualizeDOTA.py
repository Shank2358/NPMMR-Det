...
if __name__ == '__main__':
  import cv2
  imshow = cv2.imread('E:/DOTA/test/images/P0137.png')
  ...
  l = []
  p = []
  with open('E:/NPMMRDet/prediction/txt_all/P0137.txt', "r") as f:
  ...
  cv2.imwrite("E:/NPMMRDet/DOTAVisual/137.png", imshow, [int(cv2.IMWRITE_PNG_COMPRESSION),0])
